...
let result = weather === "soleado" ? "Me vestiré con un vestido" : "Me vestiré con un pantalón"; //Escribe tu código aquí;
...
result = weather === "soleado" ? "Me vestiré con un vestido" : "Me vestiré con un pantalón";
...
if (typeof value === "number") {
    ...
    console.log("No es ni un número ni string");
}
